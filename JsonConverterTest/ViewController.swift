...
extension ViewController {
    ...
    {
        let jsonString = "{\"metadata\":{\"status\":\"0000\",\"desc\":\"\"},\"data\":{\"uncommented_orders\":[{\"id\":\"17KK111111\",\"prod_name\":\"product name\",\"img_url\":\"https://img.sit.kkday.com/image/get/w_600%2Cc_fit/s1.kkday.com/product_2173/20150528034717_QInp9/jpg\",\"lst_dt_go\":\"2017-11-11 (Taipei)\"}]}}"
    ...
    private func convertToModel(for dictionary: JsonDictionary, withKey key: String)
    {
        ...
        print("\(tabSapce)\(tabSapce)let mapping: [(String?, String?)] = [")
        ...
        print()
        print("\(tabSapce)\(tabSapce)return mapping")
